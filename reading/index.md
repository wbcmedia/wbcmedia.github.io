...
<div class="scene" data-cast="all,Hildegaard,Norman,Cicely">
  ...
  <div class="scene" data-cast="all,Gideon,Candice">
    <p>2 - FOC Gideon and Candice</p>
    <audio controls src="2.mp3"></audio>
  </div>
  <div class="scene" data-cast="all,Lord Naff,Freddie,Buttermuffin,Gideon,Candice">
  ...
  <div class="scene" data-cast="all,Vicar,Gerald,Geraldine,Gideon">
    <p>5 - Funeral</p>
    <audio controls src="5.mp3"></audio>
  </div>
  <div class="scene" data-cast="all,Lord Naff,Hildegaard,Norman,Cicely">
    <p>6 - FOC Ghost Introduction</p>
    <audio controls src="6.mp3"></audio>
  </div>
  <div class="scene" data-cast="all,Freddie,Tripps,Buttermuffin,Candice">
    <p>7 - Kitchen</p>
    <audio controls src="7.mp3"></audio>
  </div>
  <div class="scene" data-cast="all,Lord Naff,Cicely,Hildegaard,Norman">
    <p>8 - Lord Naff and Cicely</p>
    <audio controls src="8.mp3"></audio>
  </div>
  <div class="scene" data-cast="all,Gideon,Barclays">
...
<script>
  function filterItems(cast) {
    ...
    const lis = document.getElementsByClassName("scene");
